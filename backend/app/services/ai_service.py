...
class AIService:
    ...
    async def analyze_ticket(
        self, subject: str, body: str, is_vip: bool = False
    ) -> Dict[str, Any]:
        """
    ...
    async def _analyze_with_ai(
        self, subject: str, body: str, is_vip: bool
    ) -> Dict[str, Any]:
...
{{
    ...
    "suggested_reply": "Your suggested reply here"
        ...
        try:
                ...
                messages=[
                    {
                        "role": "system",
                        "content": (
                            "You are a support ticket analyzer. Always respond with valid JSON."
                        ),
                    },
            ...
            priority = self._apply_business_rules(
                result.get("priority", "P3"), subject, body, is_vip
            )
            ...
            return {
                ...
                "suggested_reply": result.get(
                    "suggested_reply",
                    "Thank you for contacting support. We will investigate this issue.",
                ),
            }
        except Exception as e:
    ...
    def _analyze_with_rules(
        ...
        if any(
            word in text
            for word in ["billing", "payment", "charge", "invoice", "refund"]
        ):
            category = "Billing"
            ...
            word in text for word in ["feature", "request", "suggestion", "enhancement"]
        ):
        ...
        suggested_reply += (
            "Our team is investigating this issue and will provide an update shortly."
        )
    ...
    def _apply_business_rules(
        self, ai_priority: str, subject: str, body: str, is_vip: bool
    ) -> str:
